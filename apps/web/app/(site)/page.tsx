...
const FAQ_LD = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: '회원가입이 없습니다. 시작 전 리포트에 표시할 닉네임과 성별·나이대만 수집하며(모두 "미응답" 선택 가능), 실명·이메일·전화번호는 저장하지 않습니다. 결제 시점에는 토스페이먼츠가 카드 정보를 처리하며 본 사이트에는 카드 정보가 남지 않습니다.',
      },
    },
    {
      '@type': 'Question',
        ...
        <dl className="mt-10 divide-y divide-[var(--line)]">
          ...
          <div className="py-6">
            ...
            <dd className="mt-2 prose-editorial text-[14px]">
              ...
              토스페이먼츠가 카드 정보를 처리할 뿐 본 사이트에는 남지 않아요.
            </dd>
          </div>
          <div className="py-6">
            <dt className="font-semibold text-[15px]">
